  ...
  saveEnquiry: function (data, callback) {
    ...
    enquirydata.save(function (err, respo) {
      if (err) {
        ...
        // rajiv@tingmail.in,
        // vamsi@tingmail.in,
        // arjun.garewal@smaaash.in,
        // nilesh.jadhav@smaaash.in,
        // bhupender.singh@smaaash.in
        // vipin@tingmail.in 
        ...
        // emailData.cc =  ['karan.dhingra@smaaash.in', '"" <hussain.jagmag@1899latitudebanquets.com>' ,'"" <aadil@ting.in>','"" <rajiv@tingmail.in>','"" <vamsi@tingmail.in>','"" <arjun.garewal@smaaash.in>','"" <nilesh.jadhav@smaaash.in>','"" <bhupender.singh@smaaash.in>','"" <vipin@tingmail.in>'];
